...
final class WTRequest {
    ...
    public init(endPoint: WTEndpoint, pathComponents: [String] = [], queryParameters: [URLQueryItem] = [], httpMethod: String = "GET", headers: [String : String] = [:]) {
    ...
    convenience init?(url: URL) {
        ...
        if trimmed.contains("/") {
            ...
            guard let wtEndPoint = WTEndpoint(rawValue: endPointString) else { return nil }
            self.init(endPoint: wtEndPoint, pathComponents: pathComponents)
